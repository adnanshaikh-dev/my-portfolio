    ...
    return (
        <div className="main">
            <div className="navbar" style={{ backgroundColor: bgColor }}>
                ...
                {/* 🚀 FIXED: Desktop view ke under activeIndex aur setActiveIndex pass kar diya hai */}
                <div className="navsContainer" style={{ color: nonThemeColor }}>
                    <Routes activeIndex={activeIndex} setActiveIndex={setActiveIndex} />
                </div>
            ...
            {/* Mobile View (Yeh pehle se sahi tha) */}
            {isDropDownVisible && <div className="mob-nav" style={{ color: 'white' }}>
                <Routes onClick={handleNavigate} activeIndex={activeIndex} setActiveIndex={setActiveIndex} />
            </div>}
        </div>
    )
}
